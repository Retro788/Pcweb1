...
const CREDITS = [
    {
        ...
        rows: [['Fernando San Gabriel', 'TODO']],
    },
    {
        title: 'Modelado y texturizado',
        rows: [
            ['Fernando San Gabriel', 'Texturizacion, Composicion, & UV'],
            ['Fernando San Gabriel', 'Modelo de Computadora'],
            ['Fernando San Gabriel', 'Modelos de entorno'],
        ],
    },
    {
        title: 'Diseño de sonido',
        rows: [
            ['Fernando San Gabriel', 'Mezcla, Composicion, & Foley'],
            ['Sound Cassette', 'Audio de oficina'],
            ['Windows 95 Startup Sound', 'Microsoft'],
        ],
    },
    {
        title: 'Gracias Especiales',
        rows: [
            ['Fernando San Gabriel', 'Septiembre.IA'],
            ['Microsoft', 'Vercel'],
            ['Alison Quevedo', 'Nena'],
        ],
    },
    {
        title: 'Inspiracion',
        rows: [
            ['Elon Musk', 'Jesse Zhou'],
            ['Tyler,The Creator', 'Vivek Patel'],
        ],
    },
];
